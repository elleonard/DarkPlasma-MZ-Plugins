/// <reference path="./EvacuateStateAndMeta.d.ts" />

function Game_Temp_EvacuateStateAndMetaMixIn(gameTemp: Game_Temp) {
...
function Game_BattlerBase_EvacuateStateAndMetaMixIn(gameBattlerBase: Game_BattlerBase) {
...
function Game_Actor_EvacuateStateAndMetaMixIn(gameActor: Game_Actor) {
