/// <reference path="./UndeadTrait.d.ts" />
...
function DataManager_UndeadTraitMixIn(dataManager: typeof DataManager) {
...
function Game_Action_UndeadTraitMixIn(gameAction: Game_Action) {
...
function Game_ActionResult_UndeadTraitMixIn(gameActionResult: Game_ActionResult) {
...
function Game_BattlerBase_UndeadTraitMixIn(gameBattlerBase: Game_BattlerBase) {
  ...
  gameBattlerBase.addNewState = function (stateId) {
    if (!this._markedAntiReverse && this.hp > 0 && stateId === this.deathStateId() && this.specialFlag(reverseDeathStateSpecialFlagId.id)) {
      this.gainHpFull();
    } else {
...
function Game_Battler_UndeadTraitMixIn(gameBattler: Game_Battler) {
